...
public class GoodsOrderController {
    ...
    */
    ...
    public R update(@RequestBody GoodsOrderEntity goodsOrder, HttpServletRequest request){
        ...
        if("".equals(goodsOrder.getGoodsXuqiuPhoto()) || "null".equals(goodsOrder.getGoodsXuqiuPhoto())){
                goodsOrder.setGoodsXuqiuPhoto(null);
        }
        if("".equals(goodsOrder.getGoodsShejituPhoto()) || "null".equals(goodsOrder.getGoodsShejituPhoto())){
                goodsOrder.setGoodsShejituPhoto(null);
        }
...
//                            goodsOrderEntity.setGoodsXuqiuPhoto("");//照片
//                            goodsOrderEntity.setGoodsXuqiuText(data.get(0));                    //展柜需求详情 要改的
//                            goodsOrderEntity.setGoodsShejituPhoto("");//照片
...
//                            goodsOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        Integer goodsXuqiuPhoto = Integer.valueOf(String.valueOf(params.get("goodsXuqiuPhoto")));//展柜需求图片
        Integer goodsXuqiuText = Integer.valueOf(String.valueOf(params.get("goodsXuqiuText")));//展柜需求详情
        Integer goodsShejituPhoto = Integer.valueOf(String.valueOf(params.get("goodsShejituPhoto")));//商家设计图
    ...
    */
    ...
    public R deliver(Integer id){
        ...
        goodsOrderEntity.setGoodsOrderTypes(7);
