...
public class GoodsOrderEntity<T> implements Serializable {
     ...
     * 展柜需求图片
     */
    @TableField(value = "goods_xuqiu_photo")
     ...
     * 展柜需求详情
     */
    @TableField(value = "goods_xuqiu_text")
     ...
     * 商家设计图
     */
    @TableField(value = "goods_shejitu_photo")
    ...
    public String toString() {
        return "GoodsOrder{" +
            ...
            ", goodsXuqiuPhoto=" + goodsXuqiuPhoto +
            ", goodsXuqiuText=" + goodsXuqiuText +
            ", goodsShejituPhoto=" + goodsShejituPhoto +
