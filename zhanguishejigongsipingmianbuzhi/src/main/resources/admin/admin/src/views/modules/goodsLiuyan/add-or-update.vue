        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='goods'">
                    <el-form-item class="select" v-if="type!='info'"  label="展柜设计" prop="goodsId">
                        <el-select v-model="ruleForm.goodsId" filterable placeholder="请选择展柜设计" @change="goodsChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="展柜名称" prop="goodsName">
                        <el-input v-model="goodsForm.goodsName"
                                  placeholder="展柜名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="展柜类型" prop="goodsValue">
                        <el-input v-model="goodsForm.goodsValue"
                                  placeholder="展柜类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="材质" prop="goodsCaizhi">
                        <el-input v-model="goodsForm.goodsCaizhi"
                                  placeholder="材质" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="附加功能" prop="goodsFujia">
                        <el-input v-model="goodsForm.goodsFujia"
                                  placeholder="附加功能" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="产地" prop="goodsCandi">
                        <el-input v-model="goodsForm.goodsCandi"
                                  placeholder="产地" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="shouhouCommentbackText">
                        <el-input type="textarea"  :readonly="ro.shouhouCommentbackText" v-model="ruleForm.shouhouCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shouhouCommentbackText" label="评价内容" prop="shouhouCommentbackText">
                            <span v-html="ruleForm.shouhouCommentbackText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   goodsId: [
                              { required: true, message: '展柜不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
